package com.stockbit.automation;
...
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.stockbit.automation.steps,com.stockbit.automation.config")
...
public class CucumberTestRunner {
    // This class is empty. It's just a runner for Cucumber tests.
